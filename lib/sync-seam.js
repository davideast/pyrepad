...
firepad.SyncSeam = (function() {
  ...
  if (firepad.utils && firepad.utils.makeEventEmitter) {
    firepad.utils.makeEventEmitter(PyricSandboxAdapter, ['ready', 'cursor', 'operation', 'ack', 'retry', 'agentive', 'presence', 'worker_sync', 'reconnected']);
  } else {
    utils.makeEventEmitter(PyricSandboxAdapter, ['ready', 'cursor', 'operation', 'ack', 'retry', 'agentive', 'presence', 'worker_sync', 'reconnected']);
  }
